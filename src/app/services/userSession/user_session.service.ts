...
import { UserSession } from './user_session.types';
...
export class UserSessionService {
  private _userSession: BehaviorSubject<UserSession | null> = new BehaviorSubject<UserSession | null>(null);
  ...
  console.log('loading user session...', sessionID);
  return this._httpClient.get<UserSession>(
    `${environment.apiBaseUrl}/users/getUserSession`,
    {
      params: { sessionID },
      withCredentials: true
    }
